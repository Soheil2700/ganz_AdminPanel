                  ...
                  <div className="sm:ltr:mr-auto sm:rtl:ml-auto">
                     ...
                     >
                        <div className="relative">
                           <input
                              type="text"
                              className="peer form-input bg-gray-100 ltr:pl-9 ltr:pr-9 rtl:pl-9 rtl:pr-9 sm:bg-transparent ltr:sm:pr-4 rtl:sm:pl-4"
                              placeholder="جستجو ..."
                           />
                           <button
                              type="button"
                        ...
                        <ul className="w-[300px] !py-0 text-xs text-dark sm:w-[375px] dark:text-white-dark">
                           <li className="mb-5" onClick={(e) => e.stopPropagation()}>
                              <div className="relative !h-[68px] w-full overflow-hidden rounded-t-md p-5 text-white hover:!bg-transparent">
                                 ...
                                 <h4 className="relative z-10 text-lg font-semibold">پیام ها</h4>
                              </div>
                           </li>
                           {messages.length > 0 ? (
                              <>
                                 ...
                                 <li className="mt-5 border-t border-white-light text-center dark:border-white/10">
                                    ...
                                    >
                                       <span className="group-hover:underline ltr:mr-1 rtl:ml-1">نمایش تمام پیام ها</span>
                        ...
                        <ul className="w-[300px] divide-y !py-0 text-dark sm:w-[350px] dark:divide-white/10 dark:text-white-dark">
                           <li onClick={(e) => e.stopPropagation()}>
                              <div className="flex items-center justify-between px-4 py-2 font-semibold">
                                 <h4 className="text-lg">اعلانات</h4>
                                 {notifications.length ? (
                                    <span className="badge bg-primary/80">{notifications.length} پیغام جدید</span>
                                 ) : (
                                    ''
                                 )}
                              </div>
