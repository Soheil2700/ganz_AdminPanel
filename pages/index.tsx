   ...
   return (
      <>
               ...
               <div className="mb-6 grid gap-6 xl:grid-cols-3">
                  <div className="panel h-full xl:col-span-2">
                     <div className="mb-5 flex items-center justify-between dark:text-white-light">
                        <h5 className="text-lg font-semibold">درآمد</h5>
                        <div className="dropdown">
                           ...
                           >
                              <ul>
                                 <li>
                                    <button type="button">هفتگی</button>
                                 </li>
                                 <li>
                                    <button type="button">ماهانه</button>
                                 </li>
                                 <li>
                                    <button type="button">سالانه</button>
                                 </li>
                              </ul>
                           </Dropdown>
                        </div>
                     ...
                     <p className="text-lg dark:text-white-light/90">
                        کل سود<span className="ml-2 text-primary">$10,840</span>
                     </p>
                  ...
                  <div className="panel h-full">
                     <div className="mb-5 flex items-center">
                        <h5 className="text-lg font-semibold dark:text-white-light">فروش بر اساس دسته بندی</h5>
                     </div>
                     <div>
                        <div className="rounded-lg bg-white dark:bg-black">
                           {isMounted ? (
         ...
         {/* <div className="panel h-full sm:col-span-2 xl:col-span-1">
                     <div className="mb-5 flex items-center">
                        <h5 className="text-lg font-semibold dark:text-white-light">
                           فروش روزانه
                           <span className="block text-sm font-normal text-white-dark">برای جزئیات بیشتر به ستون ها بروید.</span>
                        </h5>
                     ...
                     <div className="mb-5 flex items-center justify-between dark:text-white-light">
                        ...
                        <div className="dropdown">
                           ...
                           >
                              <ul>
                                 <li>
                                    <button type="button">مشاهده گزارش</button>
                                 </li>
                                 <li>
                                    <button type="button">ویرایش گزارش</button>
                                 </li>
                                 <li>
                                    <button type="button">علامت گذاری به عنوان انجام شد</button>
                                 </li>
                              </ul>
                           </Dropdown>
                        </div>
         ...
         {/* <div className="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
                            ...
                            <PerfectScrollbar className="relative mb-4 h-[290px] ltr:-mr-3 ltr:pr-3 rtl:-ml-3 rtl:pl-3" options={{ suppressScrollX: true }}>
                                <div className="cursor-pointer text-sm">
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <div className="flex-1">گزارش های سرور به روز شد</div>
                                        <div className="text-xs text-white-dark ltr:ml-auto rtl:mr-auto dark:text-gray-500">به تازگی</div>
                                    ...
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <div className="flex-1">ارسال نامه به HR و Admin</div>
                                    ...
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <div className="flex-1">فایل های پشتیبان EOD</div>
                        ...
                        <div className="panel h-full">
                            <div className="mb-5 flex items-center justify-between dark:text-white-light">
                                <h5 className="text-lg font-semibold">معاملات</h5>
                                <div className="dropdown">
         ...
         {/* <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div className="panel h-full w-full">
                     ...
                     <div className="table-responsive">
                        <table>
                           <thead>
                              <tr>
                                 <th className="ltr:rounded-l-md rtl:rounded-r-md">مشتری</th>
                                 <th>محصول</th>
                                 <th>صورتحساب</th>
                                 <th>قیمت</th>
                                 <th className="ltr:rounded-r-md rtl:rounded-l-md">وضعیت</th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                 ...
                                 <td className="text-primary">هدفون</td>
                                 <td>
                                    <Link href="/apps/invoice/preview">#46894</Link>
                                 </td>
                                 <td>$56.07</td>
                                 <td>
                                    <span className="badge bg-success shadow-md dark:group-hover:bg-transparent">پرداخت شده</span>
                                 </td>
                              </tr>
                              <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                 ...
                                 <td className="text-info">نایک اسپورت</td>
                                 <td>
                                    <Link href="/apps/invoice/preview">#76894</Link>
                                 </td>
                                 <td>$126.04</td>
                                 <td>
                                    <span className="badge bg-secondary shadow-md dark:group-hover:bg-transparent">ارسال شده</span>
                                 </td>
                              </tr>
                              <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                 <td className="text-black dark:text-white">
                                    <div className="flex items-center">
                                       <img
                                          ...
                                          alt="avatar"
                                       />
                                       <span className="whitespace-nowrap">لوری فاکس</span>
                                    </div>
                                 </td>
                                 <td className="text-warning">عینک آفتابی</td>
                                 <td>
                                 ...
                                 <td className="text-black dark:text-white">
                                    <div className="flex items-center">
                                       <img
                                          ...
                                          alt="avatar"
                                       />
                                       <span className="whitespace-nowrap">رایان کالینز</span>
                                    </div>
                                 </td>
                                 <td className="text-danger">ورزشی</td>
                                 <td>
                              ...
                              <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                 ...
                                 <td className="text-secondary">بلندگوها</td>
                                 <td>
                                    <Link href="/apps/invoice/preview">#46894</Link>
                                 </td>
                                 <td>$56.07</td>
                  ...
                  <div className="panel h-full w-full">
                     <div className="mb-5 flex items-center justify-between">
                        <h5 className="text-lg font-semibold dark:text-white-light">پرفروش ترین محصولات</h5>
                     </div>
                     <div className="table-responsive">
                        <table>
                           <thead>
                              <tr className="border-b-0">
                                 <th className="ltr:rounded-l-md rtl:rounded-r-md">محصول</th>
                                 <th>قیمت</th>
                                 <th>تخفیف</th>
                                 <th>فروخته شده</th>
                                 <th className="ltr:rounded-r-md rtl:rounded-l-md">منبع</th>
                              </tr>
                           </thead>
                           <tbody>
                              <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                 <td className="min-w-[150px] text-black dark:text-white">
                                    <div className="flex">
                                       ...
                                       <p className="whitespace-nowrap">
                                          هدفون
                                          <span className="block text-xs text-primary">دیجیتال</span>
                                       </p>
                                    </div>
                                 </td>
                                 <td>$168.09</td>
                              ...
                              <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                 <td className="text-black dark:text-white">
                                    <div className="flex">
                                       ...
                                       />
                                       <p className="whitespace-nowrap">
                                          کفش <span className="block text-xs text-warning">فشن</span>
                                       </p>
                                    </div>
                                 </td>
                                 <td>$126.04</td>
                              ...
                              <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                 <td className="text-black dark:text-white">
                                    <div className="flex">
                                       ...
                                       />
                                       <p className="whitespace-nowrap">
                                          ساعت <span className="block text-xs text-danger">تجهیزات جانبی</span>
                                       </p>
                                    </div>
                                 </td>
                                 <td>$56.07</td>
                              ...
                              <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                 <td className="text-black dark:text-white">
                                    <div className="flex">
                                       ...
                                       />
                                       <p className="whitespace-nowrap">
                                          لپ تاپ <span className="block text-xs text-primary">دیجیتال</span>
                                       </p>
                                    </div>
                                 </td>
                                 <td>$110.00</td>
                              ...
                              <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                 <td className="text-black dark:text-white">
                                    <div className="flex">
                                       ...
                                       />
                                       <p className="whitespace-nowrap">
                                          دوربین <span className="block text-xs text-primary">دیجیتال</span>
                                       </p>
                                    </div>
                                 </td>
                                 <td>$56.07</td>
